...
// import MovieProjection from './assets/Movie Projector.png';
  ...
  return (
    <div className='MovieBoxProjection'>
        <div className='MovieBox'>
            ...
            <img className='MovieIcon' src='/assets/images/Movie Projector.png' alt='MovieProjection' />
                <p className='MovieText'>Movies</p>
            </div>
            <div className='TvSeries'>
                <img className='MovieIcon' src='/assets/images/TV Show.png' alt='TvShow' />
                <p className='MovieText'>TV Series</p>
            </div>
            <div className='Calander'>
                <img className='MovieIcon' src='/assets/imagesCalendar.png' alt='Calander' />
            ...
            <div className='LogOut'>
                <img className='MovieIcon' src='/assets/images/Logout.png' alt='LogOut' />
        ...
        <div className='BelowTrailer'>
            <div>
                ...
                <div className='PSpan'>
                    <p>Director : <span className='span'>Joseph Kosinski</span></p>
                    <p>Writers :  <span className='span'>Jim Cash, Jack Epps Jr,  Peter Craig</span></p>
                    <p>Stars : <span className='span'>Tom Cruise, Jennifer Connelly, Miles Teller</span>
                    </p>
                </div>
            ...
            <div className='Rectangle37Div'>
                <div className='starRate'>
                    ...
                    <span className='Rate'>8.5</span> <span className='num'> | 350k</span>
                </div>
