  ...
  return (
    <div>
        ...
        <nav className="NavBar">
          ...
          <div>
            ...
            <img
              ...
              src="/assets/images/Search (1).png"
              alt="Search"
            />
        ...
        <div className="TextRectangle">
          <div className="DescriptionBox">
            ...
            <div className="IMDbP-PngP">
              <div className="IMDbP">
                <img
                  src="/assets/images/MV5BMTk3ODA4Mjc0NF5BMl5BcG5nXkFtZTgwNDc1MzQ2OTE@ 1.png"
                  alt="IMDb"
                />
                <p>86.0 / 100</p>
              </div>
            ...
            <div className="JohnText">
              <p>
                ...
                of the international assassins guide, and with
                <br />
                ...
                <div class="item" data-testid="movie-card">
                  ...
                  <div className="IMDbP-Png-Card" id="IMDbP-PngP-Card">
                    ...
                    <div className="PngP-Card">
                      <img
                        src="/assets/images/PngItem_1381056 1.png"
                        alt="PngItem"
                      />
                      <p>97%</p>
                    </div>
      ...
      <footer>
        <div className="FIXY">
          <img
            src="/assets/images/fa-brands_facebook-square.png"
            alt="facebook"
          />
          <img
            className="instagram"
          ...
          <img
            className="x"
            src="/assets/images/fa-brands_twitter.png"
            alt="x"
          />
          <img
            className="youTube"
            src="/assets/images/fa-brands_youtube.png"
            alt="youTube"
          />
        </div>
